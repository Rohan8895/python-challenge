...
# Set Path For File
csvpath = os.path.join('/', 'Users', 'rohan', 'Documents', 'Homework', 'pythonhw', 'python-challenge', 'PyPoll', 'election_data.csv')
...
output_file = os.path.join('/', 'Users', 'rohan', 'Documents', 'Homework', 'pythonhw', 'python-challenge', 'PyPoll', 'election_data_revised.text')
